...
const Explore = () => {
        ...
        useEffect(() => {
                if (inView && !searchedPosts) fetchNextPage();
        }, [inView, searchValue]);
        if (!posts) {
                return (
        ...
        return (
                <div className="explore-container">
                        ...
                        <div className="flex-between w-full max-w-5xl mt-16 mb-8">
                                <h3 className="body-bold md:h3-bold">Popular posts for today</h3>
                        ...
                        <div className="flex flex-wrap gap-10 w-full max-w-5xl">
                                {shouldShowSearchResults ? (
                                        ...
                                        <p className="text-light-4 mt-10 text-center w-full">There is no more posts</p>
                                ) : (
